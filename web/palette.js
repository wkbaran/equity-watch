// Palette switcher (the swatch button in the lower left).
//
...
//
// index.html declares the default with data-palette="ground,ink,signal" on
...
(() => {
  "use strict";
  const KEY = "equity-watch.palette";
